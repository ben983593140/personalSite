...
function Projects() {
    ...
    var project_links = ["https://github.com/ben983593140/LStoreDB", "https://github.com/ben983593140/HoloMythSouls"]
    var project_descriptions = [
        <p>
            For my ECS 165A course, we implemented a reducted version of <a href="https://research.ibm.com/publications/l-store-a-real-time-oltp-and-olap-system">Lstore</a> Database
        </p>,
        <p>
    ...
    return (
            ...
            return (
                <div class="ProjectDiv">
                    <img src={project_icons[index]}></img>
                <div class='ProjectContent'>
                    <a class='ProjectTitle' href={project_links[index]}>{project_titles[index]}</a>
